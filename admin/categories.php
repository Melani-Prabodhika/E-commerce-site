   ...
   <!-- Button trigger modal -->
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                <button class='btn btn-secondary btn-sm '><a style="color:white;text-decoration:none;" href='manage_categories.php'>Add Categories</a></button>
                </div>
                <h2></h2>
                <h2></h2>
            </div>
            ...
            <div class="card">
                ...
                <thead>
                    ...
                    while($row=mysqli_fetch_assoc($res)){?>
                        ...
                        <td><img width="100" src="<?php echo CATEGORY_IMAGE_SITE_PATH.$row['image']?>"/></td>
                        <td>
                        <?php
                            ...
                            echo "&nbsp;<button class='btn btn-primary btn-sm'><a href='manage_categories.php?id=".$row['id']."'>Edit</a></button>&nbsp;";
