...
$css=file_get_contents('pdfcss/bootstrap.min.css');
$css.=file_get_contents('pdfcss/style.css');

$html='<center><h3>CDJ Technologies</h3></center>
      ...
      <tbody>';
		...
		$total_price=$total_price+($row['qty']*$row['price']);
         ...
         $html.='<tr>
            ...
            <td> <img style ="width:100px; object-fit:contain;" src="'.PRODUCT_IMAGE_SITE_PATH.$row['image'].'"></td>
